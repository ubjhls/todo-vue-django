...
SECRET_KEY = 'zfs4$l-%#34^v1ma^m3%f#fhet1!z6pmci2urs@e6z1pf(6f@#'
...
MIDDLEWARE = [
    ...
    'corsheaders.middleware.CorsMiddleware', # CommonMiddleware 위에 반드시 추가
...
REST_FRAMEWORK = {
    ...
    # 모든 views.py : 인증을 JWT 혹은 Session 등을 통해서 인증한다.
